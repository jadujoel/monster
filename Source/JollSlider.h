...
//    @tags{GUI}
//*/
//    class JUCE_API  JollSlider  : public Component,
...
//        When created, you can set up the slider's style and range with setSliderStyle(), setRange(), etc.
//    */
//    explicit JollSlider (const String& componentName);
//
//    /** Creates a slider with some explicit options. */
//    JollSlider (SliderStyle style, TextEntryBoxPosition textBoxPosition);
//
//    /** Destructor. */
//    ~JollSlider() override;
//
...
//#endif
//
//    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (JollSlider)
//};
//
//
//} // namespace joll
